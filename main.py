...
text = (
    ...
    "fiscales ou des voies réservées. Il est important de noter que la "
    "transition vers les voitures électriques implique également des défis, "
    "tels que l'infrastructure de recharge en expansion, la gestion des "
    "matériaux des batteries et l'autonomie limitée par rapport aux voitures "
    "à essence sur de longs trajets. Cependant, les avantages en matière "
    "d'environnement et d'efficacité continuent de renforcer l'attrait des "
    "voitures électriques pour l'avenir de la mobilité."
)
...
#   ai_response = ask_question_to_pdf(f'Analyse ma réponse {rep} par rapport
#   à ta question {question}. Ma réponse à ta question est - elle correcte?')
...
#     list_string = ['texte', 'document', 'papier', 'pdf', 'cours', 'leçon']+ \
#                   ['question']
...
#     rep = request.form['prompt']
#
#     ai_response = ask_question_to_pdf_bis(
#         f'Analyse ma réponse {rep} par rapport à ta question {question}. '
#         'Ma réponse à ta question est-elle correcte?'
#     )
#
#     return jsonify({"answer": ai_response})
